...
we tested, while increasing output tokens by 10 to 925 times (model- and domain-dependent) and making
repeated grades of the same answer less consistent in nearly every cell. Where a grading model
collapsed, assigning zero to roughly half of the code answers, reasoning repaired it; where the model
already discriminated, the gain was unpredictable. Evaluation guidance helped wherever the human
reference was trustworthy, and that qualifier became a finding in itself: on the deployment dataset,
an unvalidated human reference masked a real rubric benefit, which only became visible on the stratum
of grades with evidence of teacher review. Transfer of the public-dataset results to the deployment

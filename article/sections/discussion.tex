...
Section~\ref{sec:results}. The bottom row governs the others. Transfer was partial (the top public
configuration carried over, the mid-ranking reshuffled), effects were model-conditional (the
reasoning gain) and gold-conditional (the rubric benefit), and the gains below the top were not
predictable a priori. A deployment should therefore adopt the row that matches its task as a starting
...
on Mohler at 0.11 to 0.28; basis and regeneration: \texttt{phase5.sd\_length\_spearman}). Part of the
